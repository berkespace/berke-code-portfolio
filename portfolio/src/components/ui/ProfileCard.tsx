...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(96,73,110,0.55) 0%, rgba(113,196,255,0.2) 100%)'
...
const round = (v: number, precision = 3) => Number(v.toFixed(precision))
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        '--behind-glow-color': behindGlowColor ?? 'rgba(139, 92, 246, 0.45)',
